...
OPENCLOSE.Text = "pluemhub"
OPENCLOSE.TextColor3 = Color3.fromRGB(96, 255, 16)
OPENCLOSE.TextScaled = true
OPENCLOSE.TextSize = 14.000
OPENCLOSE.TextWrapped = true
OPENCLOSE.MouseButton1Click:Connect(function()
    game.CoreGui:FindFirstChild("pluemUI").Enabled = not game.CoreGui:FindFirstChild("pluemUI").Enabled
end)
do
...
spawn(function()
	game:GetService("RunService").Stepped:Connect(function()
		if farm or Auto_Farm or AutoFarmBone or AutoFarmChest or FramBoss or KillAllBoss or _G.AutoNew or _G.AutoThird or Auto Open Saber Room or Auto Pole V.1 or Auto Pole V.1 HOP then
